...
static char *_pfloat(long double r, char *s, int n, int flags)
{
	char *s1;
	int sign, dp;
	int i;
...
static char *_pscien(long double r, char *s, int n, int flags)
{
	int sign, dp;
	char *s1;
