...
/* CodePage 437 */
static const unsigned char font_cp437_8x16[4096] = {
    ...
    0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x00,
    0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00
};

/* Modified CodePage 437 with additional graphics glyphs */
static const unsigned char custom_cp437_8x16[4096] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,    
    0x00, 0x00, 0x7E, 0x81, 0xA5, 0x81, 0x81, 0xBD, 0x99, 0x81, 0x81, 0x7E,
    0x00, 0x00, 0x00, 0x00,
    ...
    0x18, 0x18, 0x18, 0x18,
	/* 181 Top left */
    0x7F, 0xFF, 0xC0, 0xC0, 0xFF, 0xFF, 0xC0, 0xC0, 0xFF, 0xFF, 0xC0, 0xC0,
    0xFF, 0xFF, 0xE0, 0xC0,
	/* 182 Bottom left */
    ...
    0x00, 0x00, 0x00, 0x00,
    /*
     * We are reusing greek letters for new graphic glyphs, 
     * top right, bottom right, vertical right.
     */    
    /* 224 Top right */
    0xFE, 0xFF, 0x03, 0x03, 0xFF, 0xFF, 0x03, 0x03, 0xFF, 0xFF, 0x03, 0x03,
    0xFF, 0xFF, 0x07, 0x03,
    /* 225 Bottom right */
...
static const unsigned char font_cp437_8x8[2048] =
{
...
const unsigned char *vga_get_font (enum VGA_FONTS font)
{
	switch (font)
	{
		case VGA_FONTS_CP437_8x16:
			return font_cp437_8x16;

		case VGA_FONTS_CP437_8x8:
			return font_cp437_8x8;

		case VGA_FONTS_CP437_GFX_8x16:
			return custom_cp437_8x16;
