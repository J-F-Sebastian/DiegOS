...
#ifndef RTL8139_PRIVATE_H
#define RTL8139_PRIVATE_H
...
#if 0
34 - 35 R ERBCR Early Receive(Rx)
Byte Count Register
    ...
    6 R PCS PCS Mode
    5 R T10 10 Mbps Mode 4 - 3 R PL[1 - 0] Select 10 Mbps medium type 2 - 0 R BS[2 - 0]
Select Boot ROM size 52 R / W CONFIG1 Configuration Register 1 7 - 6 R / W LEDS[1 - 0]
LED PIN
    ...
    5 a R / W CONFIG4 Configuration Register 4
    ...
    5 c - 5 d R / W MULINT Multiple Interrupt Select 15 - 12 reserved 11 - 0 R / W MISR[11 - 0]
Multiple Interrupt Select
    5e  R REVID PCI Revision ID
    ...
    9 R T4 100 Base - T4 is supported
    8 R / W TXFD 100 Base - TX full duplex is supported
    7 R / W TX 100 Base - TX is supported
    6 R / W 10F D 10 Base - T full duplex is supported
    5 R / W 10 10 Base - T is supported
    4 - 0 R / W Selector Binary encoded selector
    6 a - 6 b R ANER Auto - Negotiation Expansion Register
    15 - 5 reserved
    ...
    2 R / W Con_status_En Configures LED1 to indicate conn.stat.1 reserved
    0 R / W PASS_SCR Bypass scramble
    76 - 77 reserved
    78 - 7 b R / W PHY1_PARM PHY parameter 1
    7 c - 7f R / W TW_PARM Twister parameter
    80 R / W PHY2_PARM PHY parameter 2 81 - 83 reserved 84 - 8 b R / W CRC[0 - 7]
Power Management CRC reg.[0 - 7] for frame[0 - 7]
8 c - cb R / W Wakeup[0 - 7] Power Management wakeup frame[0 - 7] (64 bit)
    cc - d3 R / W LSBCRC[0 - 7]
LSB of the mask byte of makeup frame[0 - 7]
    ...
    1 R / W LANWake LANWake Signal 0 R / W PME_STS PME_Status bit d9 - ff reserved
#endif
#endif
